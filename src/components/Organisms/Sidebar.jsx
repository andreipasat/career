import AppSidebarLink from "../Atoms/AppSidebarLink";
...
const Sidebar = (props) => {
    ...
    return (
        <div className="p-4 text-gray-3 text-lg-1">
            <div className="px-3">
            ...
            <nav className="mt-10">
                <ul>
                    <li>
                        <AppSidebarLink to="/">Dashboard</AppSidebarLink>
                    </li>
                    <li>
                        <AppSidebarLink to="/" count={5}>Messages</AppSidebarLink>
                    </li>
                </ul>
            </nav>
    
            <h3 className="mt-10 mx-3 text-neutral-2 uppercase text-sm font-semibold">Land the job</h3>
            <nav>
                <ul>
                    <li>
                        <AppSidebarLink to="/job-search">Job Search</AppSidebarLink>
                    </li>
                    <li>
                        <AppSidebarLink to="/">Career Pathway</AppSidebarLink>
                    </li>
                    <li>
                        <AppSidebarLink to="/">Training</AppSidebarLink>
                    </li>
                    <li>
                        <AppSidebarLink to="/">Job Targeting</AppSidebarLink>
                    </li>
                    <li>
                        <AppSidebarLink to="/">Interview Prep</AppSidebarLink>
                    </li>
                    <li>
                        <AppSidebarLink to="/">Salary Negotiation</AppSidebarLink>
                    </li>
                </ul>
            </nav>
            <nav className=" mt-16">
